...
class Post
{
    ...
    #[ORM\Column(name: 'photo_blob', type: Types::BLOB, nullable: true)]
    private $photoBlob = null;

    #[ORM\Column(name: 'photo_mime_type', length: 100, nullable: true)]
    ...
    public function getPhotoBlob() { return $this->photoBlob; }
    public function setPhotoBlob($photoBlob): static { $this->photoBlob = $photoBlob; return $this; }
    ...
    public function hasPhotoBlob(): bool { return $this->photoBlob !== null; }
